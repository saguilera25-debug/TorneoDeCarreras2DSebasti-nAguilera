...
// Este script se encarga de manejar el movimiento del auto en la escena. Toma la entrada del jugador desde el CarInputHandler, y mueve el auto en consecuencia. También se encarga de manejar el salto del auto cuando pasa por un trigger de salto, y de aplicar diferentes efectos dependiendo de la superficie por la que esté pasando el auto, como más arrastre en la arena o menos arrastre en el aceite.
public class TopDownCarController : MonoBehaviour
{
    ...
    private IEnumerator JumpCo(float jumpHeightScale, float jumpPushScale, int carColliderLayerBeforeJump)
    {
        ...
        float jumpDuration = carRigidbody2D.linearVelocity.magnitude * 0.05f;
