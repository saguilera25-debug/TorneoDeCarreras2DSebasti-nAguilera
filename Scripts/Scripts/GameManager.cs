...
// Este script se encarga de manejar el estado del juego, el tiempo de carrera, y la información de los conductores. También se encarga de comunicar a otros scripts cuando el estado del juego cambia, para que puedan reaccionar en consecuencia (por ejemplo, mostrar el menú de fin de carrera cuando la carrera termina).
